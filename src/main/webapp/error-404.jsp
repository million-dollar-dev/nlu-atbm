	...
	<main id="content" role="main" class="main">
		...
		<div class="container">
			<a class="position-absolute top-0 left-0 right-0" href="index"> <img
				...
				src="https://www.sapo.pt/assets/img/homepage-sapo/facebook.jpg" alt="Image Description">
			</a>
			...
			<div
				...
				<div class="row align-items-sm-center w-100">
					<div class="col-sm-6">
						<div class="text-center text-sm-right mr-sm-4 mb-5 mb-sm-0">
							<img class="w-60 w-sm-100 mx-auto"
								src="assets\svg\illustrations\think.svg" alt="Image Description"
					...
					<div class="col-sm-6 col-md-4 text-center text-sm-left">
						...
						<p class="lead">Xin lỗi, trang bạn đang tìm kiếm không thể tìm thấy.</p>

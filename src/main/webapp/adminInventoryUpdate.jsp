...
<title>${sessionScope.user.role}| Cập nhật kho</title>
<link
	...
	<div class="container body">
		<div class="main_container">
			...
			<div class="right_col" role="main">
				<a class="button-primary btn btn-primary" href="readInventory"
					role="button">Trở về</a>
				<div class="col-md-12 col-sm-12">
					<div class="x_panel">
						<div class="x_content">
							<form class="" action="updateInventoryDone"
								method="POST">
								<span class="section">Sản phẩm:
									<h3>${product.name}</h3>
								</span>
								<c:forEach items="${map}" var="item">
									<div class="field item form-group">
										<label class="col-form-label col-md-3 col-sm-3  label-align">Size ${item.key}:
											<span ></span>
										</label>
										<div class="col-md-6 col-sm-6">
											<input class="form-control" type="number" class='number'
												name="${item.key}" data-validate-minmax="10,100"
												 value="${item.value}">
								...
								<div class="ln_solid">
									<div class="form-group">
										<div class="col-md-6 offset-md-3">
											...
											<input type='submit' class="btn btn-primary button-primary"
												onclick="return alert('Cập nhật thành công');" value="Cập nhật"/>
										</div>
									</div>
								</div>
							</form>

...
<link rel="icon" href="admin/admin/favicon.png" type="image/ico" />
...
<title>${sessionScope.user.role}| Thêm tài khoản</title>
<link
					...
					<div class="x_panel">
						<div class="x_content">
							<form class="" action="createUser" method="post">
								...
								<div class="field item form-group">
									<label class="col-form-label col-md-3 col-sm-3  label-align">Mật
								...
								<c:if test="${mess != null}">
									<script>
										...
										window.location.href = 'adminAccountCreate.jsp';
									</script>
								</c:if>
								<div class="ln_solid">
